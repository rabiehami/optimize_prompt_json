...
| `max_tokens`           | `8192`                          | Max token length for synthetic text generation prompts |
| `max_output_tokens`    | `8192`                          | Max output tokens passed to the LLM API (`max_tokens` in litellm) |
